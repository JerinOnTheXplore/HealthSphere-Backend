...
-- CreateIndex
CREATE INDEX "idx_doctor_specialty_specialtyId" ON "doctor_specialties"("specialityId");

-- CreateIndex
CREATE UNIQUE INDEX "doctor_specialties_doctorId_specialityId_key" ON "doctor_specialties"("doctorId", "specialityId");
...
-- AddForeignKey
ALTER TABLE "doctor_specialties" ADD CONSTRAINT "doctor_specialties_specialityId_fkey" FOREIGN KEY ("specialityId") REFERENCES "specialities"("id") ON DELETE CASCADE ON UPDATE CASCADE;
